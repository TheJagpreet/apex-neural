...
# Use the apex-neural_memory tool (#apex_memory) for store/recall/list operations.
$MemoryHint = "Memory: Use #apex_memory tool (apex-neural_memory) for store/recall/list."
