...
user-invocable: true
tools: ['read/readFile', 'search', 'edit', 'vscode/memory', 'read/problems', 'search/usages', 'execute/getTerminalOutput', 'execute/runInTerminal', 'read/terminalLastCommand', 'read/terminalSelection', 'search/listDirectory']
---
